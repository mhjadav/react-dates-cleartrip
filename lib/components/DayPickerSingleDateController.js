...
var _object3 = __webpack_require__(25);
...
var _isBeforeDay = __webpack_require__(21);

var _isBeforeDay2 = _interopRequireDefault(_isBeforeDay);

var _getVisibleDays = __webpack_require__(32);
  ...
  _createClass(DayPickerSingleDateController, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        ...
        if (didDateChange) {
          modifiers = this.deleteModifier(modifiers, this.props.startDate, 'selected');
          modifiers = this.addModifier(modifiers, startDate, 'selected');
        }
    ...
    value: function () {
      function isSelected(day) {
        return (0, _isBeforeDay2['default'])(day, this.props.endDate) && (0, _isAfterDay2['default'])(day, this.props.startDate);
      }
